        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="./assets/images/hotelheader.jpg" alt="Roel Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content"><center>
                        <h1>
                            Welcome to <span className="phegon-color">Roel Hotel</span>
                        </h1><br />
                        <h3>Come and Enjoy </h3></center>
                    </div>
                </header>
            </section>
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Roel Hotel</span></h2>
