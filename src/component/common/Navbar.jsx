    ...
    return (
        <nav className="navbar">
            <div className="navbar-brand">
                <NavLink to="/home">Roel Hotel</NavLink>
            </div>
            <ul className="navbar-ul">
                <li><NavLink to="/home" activeclassname="active">Home</NavLink></li>
                <li><NavLink to="/rooms" activeclassname="active">Rooms</NavLink></li>
                {(isUser||isAdmin) && <li><NavLink to="/find-booking" activeclassname="active">Find my Booking</NavLink></li>}

                {isUser && <li><NavLink to="/mybookings" activeclassname="active">My Bookings</NavLink></li>}
